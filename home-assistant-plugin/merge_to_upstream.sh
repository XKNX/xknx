...
then
    ...
    cp ${XKNX_REPO}/home-assistant-plugin/custom_components/xknx/*.{py,json,yaml} ${HA_UPSTREAM}/homeassistant/components/knx/
    ...
    rm ${HA_UPSTREAM}/homeassistant/components/knx/*.bak
fi
