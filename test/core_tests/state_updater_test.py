...
class TestStateUpdater(unittest.TestCase):
    ...
    def test_tracker_parser(self):
        ...
        self.assertEqual(_get_only_tracker().tracker_type, StateTrackerType.EXPIRE)
        self.assertEqual(_get_only_tracker().update_interval, 30 * 60)
        remote_value_expire.__del__()
        ...
        self.assertEqual(
            _get_only_tracker().tracker_type, StateTrackerType.PERIODICALLY
        )
        self.assertEqual(_get_only_tracker().update_interval, 60 * 60)
        ...
        self.assertEqual(_get_only_tracker().update_interval, 10 * 60)
        remote_value_every.__del__()
