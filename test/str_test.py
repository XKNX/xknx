...
class TestStringRepresentations(unittest.TestCase):
    ...
    def test_telegram(self):
        ...
        self.assertEqual(
            str(telegram),
            '<Telegram source_address="PhysicalAddress("0.0.0")", destination_address="GroupAddress("1/2/3")", payload="<DPTBinary value="7" />" telegramtype="TelegramType.GROUP_WRITE" direction='
