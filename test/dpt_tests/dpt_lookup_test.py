...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("alarm_control", DPTAlarmControl, 2, 5, None),
        ...
        ("binary_value_control", DPTBinaryValueControl, 2, 6, None),
        ("bool", DPTBool, 1, 2, None),
        ("bool_control", DPTBoolControl, 2, 2, None),
        ...
        ("delta_volume_liquid_litre", DPTDeltaVolumeLiquidLitre, 13, 1200, "L"),
        ("delta_volume_m3", DPTDeltaVolumeM3, 13, 1201, "m³"),
        ("density", DPTDensity, 14, 17, "kg/m³"),
        ("dim_send_style", DPTDimSendStyle, 1, 13, None),
        ("direction1_control", DPTDirection1Control, 2, 8, None),
        ("direction2_control", DPTDirection2Control, 2, 9, None),
        ...
        ("enable_control", DPTEnableControl, 2, 3, None),
        ...
        ("invert_control", DPTInvertControl, 2, 12, None),
        ...
        ("ramp_control", DPTRampControl, 2, 4, None),
        ...
        ("volume_flux_ls", DPTVolumeFluxLs, 14, 1201, "L/s"),
        ("volume_flux_meter", DPTVolumeFluxMeter, 14, 1200, "m³/h"),
