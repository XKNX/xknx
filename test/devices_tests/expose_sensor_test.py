...
class TestExposeSensor(unittest.TestCase):
    ...
    async def test_set_binary(self):
        ...
        expose_sensor = ExposeSensor(
            ...
            group_address='1/2/3',
            value_type="binary")
        await asyncio.Task(expose_sensor.set(False))
    ...
    async def test_set_percent(self):
        ...
        expose_sensor = ExposeSensor(
            ...
            group_address='1/2/3',
            value_type="percent")
        await asyncio.Task(expose_sensor.set(75))
        self.assertEqual(xknx.telegrams.qsize(), 1)
    ...
    async def test_set_temperature(self):
        ...
        expose_sensor = ExposeSensor(
            ...
            group_address='1/2/3',
            value_type="temperature")
        await asyncio.Task(expose_sensor.set(21.0))
        self.assertEqual(xknx.telegrams.qsize(), 1)
        telegram = xknx.telegrams.get_nowait()
        self.assertEqual(
            telegram,
    ...
    async def test_process_binary(self):
        ...
        await asyncio.Task(expose_sensor.process(telegram))
        self.assertEqual(xknx.telegrams.qsize(), 1)
        telegram = xknx.telegrams.get_nowait()
        self.assertEqual(
            telegram,
