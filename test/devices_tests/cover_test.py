...
class TestCover(Testcase):
    ...
    #
    @pytest.mark.anyio
    async def test_supports_position_true(self):
    ...
    @pytest.mark.anyio
    async def test_supports_position_false(self):
        """Test support_position_true."""
        xknx = XKNX()
        cover = Cover(
            xknx,
    ...
    @pytest.mark.anyio
    async def test_supports_angle_true(self):
        """Test support_position_true."""
        xknx = XKNX()
        cover = Cover(
            xknx,
    ...
    @pytest.mark.anyio
    async def test_support_angle_false(self):
        """Test support_position_true."""
        xknx = XKNX()
        cover = Cover(
            xknx,
    ...
    async def test_auto_stop(self):
        ...
        cover = Cover(
            ...
            travel_time_down=10,
            travel_time_up=10)
        with patch('xknx.devices.Cover.stop', new_callable=AsyncMock) as mock_stop, patch('time.time') as mock_time:
            mock_time.return_value = 1517000000.0
            await cover.set_position(50)
