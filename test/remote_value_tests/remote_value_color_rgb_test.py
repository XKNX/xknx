...
class TestRemoteValueColorRGB(unittest.TestCase):
    ...
    def test_to_knx(self):
        ...
        self.assertEqual(
            remote_value.to_knx((100, 101, 102)), DPTArray((0x64, 0x65, 0x66))
        )
        self.assertEqual(
            remote_value.to_knx([100, 101, 102]), DPTArray((0x64, 0x65, 0x66))
        )
    ...
    def test_from_knx(self):
        ...
        remote_value = RemoteValueColorRGB(xknx)
        self.assertEqual(
            remote_value.from_knx(DPTArray((0x64, 0x65, 0x66))), (100, 101, 102)
        )
    ...
    def test_set(self):
        ...
        self.loop.run_until_complete(remote_value.set((100, 101, 102)))
