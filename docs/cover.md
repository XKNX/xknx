...
- `device_class` may be used to store the type of cover, e.g. "shutter" for Home-Assistant (see [Cover Integration](https://www.home-assistant.io/integrations/cover/) for details).
