...
- Add A_PropertyExtValue_Read, A_PropertyExtValue_Response, A_PropertyExtValue_WriteCon, A_PropertyExtValue_WriteConRes, A_PropertyExtValue_WriteUnCon and A_PropertyExtValue_InfoReport APCI service parsing. Recognize A_PropertyExtDescription_Read/Response APCI services; payload parsing not implemented yet for those (raises `NotImplementedError`).
