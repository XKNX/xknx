...
- Add A_PropertyExtValue_Read, A_PropertyExtValue_Response, A_PropertyExtValue_WriteCon, A_PropertyExtValue_WriteConRes and A_PropertyExtValue_WriteUnCon APCI service parsing. Recognize A_PropertyExtValue_InfoReport and A_PropertyExtDescription_Read/Response APCI services; payload parsing not implemented yet for those (raises `NotImplementedError`).
