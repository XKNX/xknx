...
from xknx.dpt import (
    DPT2ByteFloat, DPT2ByteSigned, DPT2ByteUnsigned, DPT2Ucount, DPT4ByteFloat, DPT4ByteSigned, DPT4ByteUnsigned,
    DPTAbsoluteTemperature, DPTAcceleration, DPTAccelerationAngular, DPTActivationEnergy, DPTActiveEnergy,
    DPTActiveEnergykWh, DPTActivity, DPTAmplitude, DPTAngle, DPTAngleDeg, DPTAngleRad, DPTAngularFrequency,
    DPTAngularMomentum, DPTAngularVelocity, DPTApparantEnergy, DPTApparantEnergykVAh, DPTArea, DPTArray, DPTBrightness,
    DPTCapacitance, DPTChargeDensitySurface, DPTChargeDensityVolume, DPTColorTemperature, DPTCommonTemperature,
    DPTCompressibility, DPTConductance, DPTDeltaTimeHrs, DPTDeltaTimeMin, DPTDeltaTimeMsec, DPTDeltaTimeSec, DPTDensity,
    DPTElectricalConductivity, DPTElectricCharge, DPTElectricCurrent, DPTElectricCurrentDensity,
    DPTElectricDipoleMoment, DPTElectricDisplacement, DPTElectricFieldStrength, DPTElectricFlux, DPTElectricFluxDensity,
    DPTElectricPolarization, DPTElectricPotential, DPTElectricPotentialDifference, DPTElectromagneticMoment,
    DPTElectromotiveForce, DPTEnergy, DPTEnthalpy, DPTFlowRateM3H, DPTForce, DPTFrequency, DPTHeatCapacity,
    DPTHeatFlowRate, DPTHeatQuantity, DPTHumidity, DPTImpedance, DPTKelvinPerPercent, DPTLength, DPTLengthMm,
...
class RemoteValueSensor(RemoteValue):
    ...
    DPTMAP = {
        ...
        'parts_per_million': DPTPartsPerMillion,
        'percent': DPTScaling,
