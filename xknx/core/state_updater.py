        ...
        def parse_tracker_options(tracker_options):
            ...
            if isinstance(tracker_options, int):
                ...
                if _options[0].upper() == "INIT":
                    ...
                    self.xknx.logger.warning('Cannot parse StateUpdater tracker_options "%s" for %s. Using default %s %s minutes.' %
                ...
                self.xknx.logger.warning('Cannot parse StateUpdater tracker_options type %s "%s" for %s. Using default %s %s minutes.' %
